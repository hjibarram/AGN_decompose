...
def map_ana(map,mapE,hdr,sig=2,prior_config='priors_prop.yaml',Usermods=['extern','pathext','extern_function.py'],mod_ind=0,mod_ind0=0,verbose=False,dir_o='',name='spectra',ncpu=10):
